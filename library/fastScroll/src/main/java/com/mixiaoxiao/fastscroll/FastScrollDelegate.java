...
public class FastScrollDelegate {
	...
	public void onVisibilityChanged(View changedView, int visibility) {
		if (visibility == View.VISIBLE) {
            ...
            if (Build.VERSION.SDK_INT >= 19) {
                isAttachedToWindow = mView.isAttachedToWindow();
            } else {
                isAttachedToWindow = mView.getWindowToken() != null;
            }
	...
	public static int FASTSCROLLER_WIDTH_DP = 40;// 12;
	public static int FASTSCROLLER_MIN_HEIGHT_DP = 32;
	public static int FASTSCROLLER_THUMB_WIDTH = 4;
	public static int FASTSCROLLER_THUMB_INSET_TOP_BOTTOM_RIGHT = 0;
	...
	public static class Builder {
		...
		public Builder(FastScrollable fastScrollable) {
            ...
            if (Build.VERSION.SDK_INT >= 21) {
                Context context=fastScrollable.getFastScrollableView().getContext();
                TypedArray a= context.obtainStyledAttributes(new int[]{android.R.attr.colorAccent});
                thumbPressedColor = a.getInt(0, thumbPressedColor);      
            }      
